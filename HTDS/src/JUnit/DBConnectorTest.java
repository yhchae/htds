...
public class DBConnectorTest {
	...
	public void testLogin(){
		User user = dbConnector.login("agent", "1");
		assertNotNull(user);
	}
	...
	public void testDeleteUser(){
		User user = new User("unitTest", "unitTest", "unitTest");
		assertTrue(dbConnector.removeUser(user));
	}

	@Test
	public void testUploadFile(){
		dbConnector.login("agent", "1");
		String filename = "C:\\Users\\Zachary\\Documents\\CSC 505\\Prussia.txt";
	...
	public void testUpdateUserPassword(){
		...
		User user = new User("Administrator", null, null);
	...
	public void testGetAlerts(){
		...
		Alert[] test5 = dbConnector.getAlerts("Dorthey  Morris", DBConnector.VICTIM_NAME);
		assertNotNull(test5);
